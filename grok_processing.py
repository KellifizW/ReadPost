    ...
    for tid, data in thread_data_dict.items():
        ...
        try:
            ...
            filtered_thread_data[tid] = {
                ...
                "no_of_reply": data.get("no_of_reply", 0) or data.get("total_replies", 0),
            ...
            candidate_threads = [
                {
                    "thread_id": str(tid),
                    "title": "",
                    "no_of_reply": next((item.get("no_of_reply", 0) for item in initial_threads if str(item["thread_id"]) == str(tid)), 0),
                    "like_count": 0
                }
